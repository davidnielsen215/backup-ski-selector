...
import {  RadioGroup, AppBar, FormControlLabel, 
    Radio, FormControl, Card, CardContent } from '@material-ui/core'
                        ...
                        <Card className='card'>
                            <CardContent>
                                ...
                                <FormControl component="fieldset" >
                                    <RadioGroup onChange={handleChange('turnRadius')} >
                                        <FormControlLabel onClick={this.progressStep} value="s" control={<Radio color="primary"/>} label={<p style={styles.form}>Short</p>}/>
                                        <FormControlLabel onClick={this.progressStep} value="m" control={<Radio color="primary"/>} label={<p style={styles.form}>Medium</p>}/>
                                        <FormControlLabel onClick={this.progressStep} value="l" control={<Radio color="primary"/>} label={<p style={styles.form}>Long</p>}/>
